...
static bgfx::VertexLayout  g_VertexDecl;
...
// structure) If text or lines are blurry when integrating ImGui in your engine:
...
void ImGui_Implbgfx_Init(int view) {
    ...
    // io.RenderDrawListsFn = ImGui_Implbgfx_RenderDrawLists; // Alternatively you can set this to NULL and call ImGui::GetDrawData() after
